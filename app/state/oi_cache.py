...
# Default to False; only enable explicitly for local testing
# Set ALLOW_SIMULATED_OI=true when you intentionally want synthetic data
ALLOW_SIMULATED_OI = os.environ.get("ALLOW_SIMULATED_OI", "false").lower() == "true"
